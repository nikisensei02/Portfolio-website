...
export default function Social() {
    ...
    return (
        <div className={`fixed z-10 ${location.pathname === '/projects' ? 'text-black' : 'text-white'} ${location.pathname === '/projects' ? 'z-0' : 'z-10'}`}>
            ...
            <div className="logo ml-[2vw] md:ml-[0.7vw] mt-[80vh] md:mt-[0vh]">
                <div className='flex rounded-3xl w-[20px] my-4 cursor-pointer md:text-white'>
